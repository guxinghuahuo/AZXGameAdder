...
这是一个用于解决Nikke AZX小游戏的 Python 工具。该项目使用 **OpenCV** 进行图像识别（模板匹配），并能通过简单的算法自动寻找最优解。

**目前仅支持1080分辨率下的*索林*。其他角色效果不一定好，可以通过重新制作数字模版来解决**

我是懒狗，让AI帮我写了README.md。所以以下内容均由AI生成，请注意甄别。
